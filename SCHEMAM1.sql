...
CREATE TABLE PRESTAMO_DETALLE (
    ...
    CANTDET char (1)NULL COMMENT 'En este campo se especificaran que tipo de libro llevara el lector.',
    FECHENT date  NULL COMMENT 'FECHA DE ENTREGA DEL LIBRO',
...
ALTER TABLE USUARIO ADD CONSTRAINT USUARIO_PERSONA FOREIGN KEY USUARIO_PERSONA (IDPER)
    REFERENCES PERSONA (IDPER);
